...
export default function CaseDetail() {
  ...
  const [newEvent, setNewEvent] = useState({
    title: "",
    description: "",
    eventType: "note" as TimelineEventEventType,
  ...
  const getEventIcon = (type: string) => {
    switch (type) {
      ...
      case "document":
        return <FileSignature className="w-4 h-4 text-blue-400" />;
      case "deadline":
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(v: TimelineEventEventType) => setNewEvent({ ...newEvent, eventType: v })}
                        >
